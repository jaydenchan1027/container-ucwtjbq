...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ucwtjbq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ucwtjbq.containers.anotherwebservice.com/
...
```
git clone git@github.com:jaydenchan1027/container-ucwtjbq.git
cd container-ucwtjbq
```
...
```
docker attach container-ucwtjbq
```
